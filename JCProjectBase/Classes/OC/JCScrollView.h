...
/**
 ...
 @return            返回cell总数
 */
- (NSInteger)numOfContentViewScrollView:(JCScrollView *)scrollView;
...
/**
 ...
 @return            返回自定义View
 */
- (JCSubView *)scrollView:(JCScrollView *)scrollView subViewFrame:(CGRect)frame cellAtIndex:(NSInteger)index;
 ...
 */
- (void)scrollView:(JCScrollView *)scrollView didSelectedAtIndex:(NSInteger)index;
 ...
 */
- (void)scrollView:(JCScrollView *)scrollView didCurrentCellAtIndex:(NSInteger)index;

@end
@interface JCScrollView : UIView

@property (nonatomic,strong)UIScrollView *scrollView;
@property (nonatomic, readonly) NSInteger index;//标记数据源位置
@property (nonatomic,assign)id<JCScrollViewDelegate> delegate;
